...
interface FormCreateVariantOptionProps {
  onSubmit: (name: string) => void;
}

const FormCreateVariantOption: React.FC<FormCreateVariantOptionProps> = ({ onSubmit }: FormCreateVariantOptionProps) => {
...
export default FormCreateVariantOption;
