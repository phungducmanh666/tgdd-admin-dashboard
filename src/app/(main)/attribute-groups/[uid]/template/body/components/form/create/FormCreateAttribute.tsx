...
interface FormCreateAttributeProps {
  onSubmit: (name: string) => void;
}

const FormCreateAttribute: React.FC<FormCreateAttributeProps> = ({ onSubmit }: FormCreateAttributeProps) => {
...
export default FormCreateAttribute;
